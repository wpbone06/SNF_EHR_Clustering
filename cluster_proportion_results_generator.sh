...
cat ./results_silhouette_values_SNFtool_X_$fileName.txt | tr " " "\t" | sed "s/.d/_/" | tr "_" "\t" | cut -f 5,11,17 | sort -nk 2 > ./results_silhouette_values_SNFtool_X_"$fileName"_dataframe.txt
