...
################################################################################
## cat3: Generate 5 level categorical values from continuous values

################################################################################
def cat3(vector):

    return pd.qcut(vector, [0, .20, .40, .60, .80, 1]).codes
...
def main():
    ...
    #Currently script only generates 5 cluster simulated data
