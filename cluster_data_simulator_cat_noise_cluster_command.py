...
def main():
    ...
    ## Parsing arguments from command line
        ...
        try:
            ...
            print("Usage: %s -n n_samples -x sig_cont -y sig_cat -w cat_noise_feat -z cont_noise_feat -s seed -c # of clusters" % sys.argv[0])
            print helpstatement
            exit(1)
