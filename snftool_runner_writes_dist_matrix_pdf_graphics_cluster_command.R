...
clusters = as.numeric(arg_clusters)
...
print(T)
print("Number of clusters in the data provided:")
print(clusters)
...
print("group.dum = spectralClustering(W.dum,# of clusters)")
...
#commented out to save disk space for the  large number of simulations
