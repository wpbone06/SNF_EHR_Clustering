...
#snftool_runner.sh
#NOTE!!!!: script currently assumes you are providing a cluster label file with 5 clusters
...
print("NOTE!!!!: script currently assumes you are providing a cluster label file with 5 clusters!")
...
print("group.dum = spectralClustering(W.dum,5)")
print("SNFcluster.dum <- as.data.frame(group.dum)")
group.dum = spectralClustering(W.dum,5)
