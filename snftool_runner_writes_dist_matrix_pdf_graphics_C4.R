...
#snftool_runner.sh
#NOTE!!!!: script currently assumes you are providing a cluster label file with 4 clusters
...
print("NOTE!!!!: script currently assumes you are providing a cluster label file with 4 clusters!")
...
print("group.dum = spectralClustering(W.dum,4)")
print("SNFcluster.dum <- as.data.frame(group.dum)")
group.dum = spectralClustering(W.dum,4)
